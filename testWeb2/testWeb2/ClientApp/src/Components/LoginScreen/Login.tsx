...
export const LoginScreen = () => {
    ...
    let passwordOnChangeHandler = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
        ...
        <div className="LoginScreen">
            <Button color="light" onClick={toggle}>Login</Button>
            ...
            <Modal isOpen={modal} toggle={toggle} className='Modal'>
                ...
                <ModalBody>
                    ...
                    <Input type="text" onChange={loginOnChangeHandler} name="Login" id="LoginINPUT" placeholder="Input login"></Input>
                    <Label for="PasswordINPUT" >Password</Label>
                    <Input type="password" onChange={passwordOnChangeHandler} name="password" id="PasswordINPUT" placeholder="Input password"></Input>
                </ModalBody>
                <ModalFooter>
