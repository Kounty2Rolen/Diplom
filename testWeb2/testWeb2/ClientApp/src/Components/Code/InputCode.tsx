...
export class InpCode extends React.Component<{}, state> {
    ...
    codeCompile = () => {
        let Code = {
            ...
            ContextName: document.getElementsByClassName("connectionComponentContext")[0].nodeValue? document.getElementsByClassName("connectionComponentContext")[0].nodeValue :"Context"
        };
