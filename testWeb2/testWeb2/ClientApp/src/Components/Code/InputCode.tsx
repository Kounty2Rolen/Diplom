...
export class InpCode extends React.Component<{}, state>{
    ...
    constructor( porps: any) {
        super(porps);
        this.state = { CodeResult: "", SourceCode: "", connectionString: "", Context: "" };
    }
    codeCompile = () => {
        let Code = {
        ...
        if (this.state.SourceCode.length >= 0) {//отправка данных в index() генерация и выполнение кода
            fetch('SampleData',
                {
                    method: 'POST',
    ...
    render() {
        return (
            ...
            <div>
                ...
                <br/>
                <Button className="btnConnect" color="danger" onClick={this.codeCompile}>Submit</Button>
